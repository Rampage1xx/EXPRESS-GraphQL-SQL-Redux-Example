...
import { addLikeMutation, agent1, createImageMutation, createUserMutation, imageFind, removeLikeMutation, userFind } from './variables';
...
describe('testing graphql resolve functions', () =>
{
    ...
    it('should remove a like', async () =>
    {
        ...
        const imageAfter: any = await imageFind('test1');
        const findDeletedLike = await LikeSequelize.findById(deletedLikeID);
