...
export const NotLoggedInComponents = (props) => {
    ...
    return id !== 'Guest' || !id ?
        ...
        (
            <div>
                <NavWrapping>
                    <ModalComponent name = { 'Login' } closeModal = { closeModal } activeModal = { activeModal }>
                        <LoginModalAddOn />
                    </ModalComponent>
                </NavWrapping>

                <NavWrapping>
                    <ModalComponent name = { 'Create Account' } closeModal = { closeModal } activeModal = { activeModal }>
